      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          >
            <img
              alt={profile}
              className="  z-10 w-full max-w-[400px] md:max-w-[600px] rounded-t-full filter grayscale "
              src={profile}
            />
          </div>
        ) : (
          <img
            alt={profile}
            class="filter grayscale rounded-t-full "
            className="z-10 w-full max-w-[250px] md:max-w-[600px] rounded-t-full filter grayscale"
            src={profile}
          />
        )}
      </div>
